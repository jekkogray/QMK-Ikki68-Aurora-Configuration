...
enum layer_names { _BASE, _VIA1, _VIA2, _VIA3 };

#define KC_DISC_MUTE KC_F23
#define KC_DISC_DEAF KC_F24

enum custom_keycodes { PROG = SAFE_RANGE, DISC_MUTE, DISC_DEAF, SUPER_ALT_TAB, _NUM_CUST_KCS, CHANGE_ENCODER_LAYER };

enum encoder_layer { DEFAULT_ENCODER, ART_ENCODER, MEDIA_ENCODER };
...
//     //,---,-----',--',--',--',--',--',--',--',--',--',--',--',--------,---,
//     //|F1 | fn   | A | S | D | F | G | H | J | K | L | ; | " |  Enter |pu |
//     //,---,------'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'-,-'----,---,---,
//     //|F2 | Shift  | Z | X | C | V | B | N | M | < | > | ? |Shift | ↑ |pd |
//     //|---,----,---',--'-,'---'---'-,--',--'---'--,'--,'--,'--,---,---,---,
//     //|F3 |ctrl|win |alt | Space    |Ent| <-      |alt|fn |ctl| ← | ↓ | → |
//     // ---'----'----'----'----------'---'---------'---'---'---'---'---'---'
//     [_BASE] = LAYOUT_iso(
//                 KC_GESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_GRV,
//         CHANGE_ENCODER_LAYER, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,
//         KC_F13, MO(_VIA1), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_PGUP,
//         KC_F14, KC_LSFT, KC_BSPC, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_PGDN,
//         KC_F15, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, MO(_VIA2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
//     ),
//     //,-------------------------------------------------------------------,
//     //|[ ]|[====]iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii████████iii|
//     //|;;;,---,---,---,---,---,---,---,---,---,---,---,---,---,-------,---,
...
//         _______, KC_CAPS, _______, KC_UP, _______, _______, _______, _______, _______, KC_UP, _______, _______, _______, _______, _______, _______,
//         _______, KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______,
...
//     // ---'----'----'----'----------'---'---------'---'---'---'---'---'---'
// [_VIA2] = LAYOUT_iso(
//        _______,  AG_NORM, AG_SWAP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
//     ),
 ...
 [_BASE] = LAYOUT_iso(
    ...
    CHANGE_ENCODER_LAYER,  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          KC_DEL,
    RGB_TOG,  MO(_VIA1), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_NUHS,  KC_PGUP,
    KC_F15,  KC_LSFT, KC_BSPC, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,   KC_RSFT, KC_UP,   KC_PGDN,
    KC_F16,  KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    KC_RALT, MO(_VIA2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_VIA1] = LAYOUT_iso(
...
void change_encoder_layer(void) { current_encoder_layer = (current_encoder_layer + 1) % 3; }
...
#    endif
    ...
    switch (keycode) {
        ...
        case CHANGE_ENCODER_LAYER:
            if (record->event.pressed) {
                change_encoder_layer();
            }
        default:
            break;
    }
